...
#include <memory>
#include "../inputmonitor/wrapper.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Wrapper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Wrapper_t qt_meta_stringdata_Wrapper = {
    {
QT_MOC_LITERAL(0, 0, 7) // "Wrapper"
...
QT_INIT_METAOBJECT const QMetaObject Wrapper::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Wrapper.data,
